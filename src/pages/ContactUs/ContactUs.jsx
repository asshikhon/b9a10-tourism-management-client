import imgContact from "../../../src/assets/images/contact-us.jpg";
...
<title>HomeHaven || Contact</title>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="sm:mt-3 md:mt-6 rounded-xl bg-[rgba(255,255,255,0.8)] py-4 lg:py-8 px-4 lg:px-8 shadow sm:rounded-lg sm:px-10">
