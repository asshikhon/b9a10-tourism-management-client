  ...
  return (
    <div className="mt-12 mb-32">
      ...
      <p className="text-base font-medium text-center  mb-10">
        Explore diverse cultures and breathtaking landscapes in our Country
        section. Discover hidden gems, iconic landmarks, and immersive
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 ">
        {countries.map((country) => (
          <Link
            ...
            key={country._id}
            className="card bg-base-100 shadow-xl dark:bg-white  dark:text-black h-[520px] "
          >
