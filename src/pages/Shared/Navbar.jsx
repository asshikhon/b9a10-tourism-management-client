...
<li className="">
  ...
  return (
    <div
      ...
      className="navbar bg-base-100 max-w-6xl mx-auto mt-4"
    >
...
TourismTrek
  ...
  <input onChange={handleToggle} type="checkbox" checked={theme === 'dark'} className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2"/>
