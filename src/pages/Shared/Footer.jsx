	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3" >
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
             ...
             <img src="" alt="" />
				<span className="self-center text-2xl font-semibold">TourismTrek</span>
				</div>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4" >
			...
			<div className="space-y-3" >
				<div className="uppercase text-xl font-semibold text-gray-50 dark:text-gray-900" >Social media</div>
				<div className="flex justify-start space-x-3" >
					...
					<a rel="noopener noreferrer" href="#" title="Github" className="flex items-center p-1 text-sm">
                    <svg className='text-xl w-[24px]' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
...
<h6 className="text-xl font-bold">Newsletter</h6> 
    <fieldset className="">
      <label className="label">
        <span className="label-text text-lg font-semibold">Enter your email address</span>
      </label> 
      <div className="lg:join">
        <input type="text" placeholder="user@site.com" className="input w-36 input-bordered  lg:join-item text-sm" /> 
        <button className="btn   btn-primary text-base font-semibold join-item">Subscribe</button>
      </div>
    </fieldset>
...
<h6 className="footer-title">Newsletter</h6> 
    <fieldset className="form-control">
      ...
      <div className="join">
        <input type="text" placeholder="user@site.com" className="input w-32 input-sm input-bordered join-item" /> 
